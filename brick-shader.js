...
void main() {
    ...
    highp vec4 worldPosition = u_modelMatrix * vec4(a_position * 0.5, 1.0);
    gl_Position = u_projectionMatrix * u_viewMatrix * worldPosition;
    v_screenpos = gl_Position.xy / gl_Position.z;

    v_alpha = u_brickDepth <= u_paddleDepth ? 1.0 : 0.5;
...
void main() {
    highp vec4 out_color = vec4(v_texcoord * v_brightness, 0.0, v_alpha);
